...
/// Gets or sets the app switch behavior. Defaults to <code>.disabled</code>
...
/// The app switch behavior. Defaults to <code>.disabled</code>.
...
/// @param messengerPageId the associated page id  to use for a login attempt.
/// @param authType auth_type param to use for login.
/// @param appSwitch the app switch behavior to use for a login attempt. Defaults to <code>.disabled</code>.
